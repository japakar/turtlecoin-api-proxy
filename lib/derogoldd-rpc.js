...
var DeroGoldRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof DeroGoldRPC)) return new DeroGoldRPC(opts)
...
DeroGoldRPC.prototype.getBlocks = function (opts) {
...
DeroGoldRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
DeroGoldRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
DeroGoldRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
DeroGoldRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
DeroGoldRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getHeight = function () {
  return this.height()
}

DeroGoldRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getInfo = function () {
  return this.info()
}

DeroGoldRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.feeInfo = function () {
  return this.fee()
}

DeroGoldRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getPeers = function () {
  return this.peers()
}

DeroGoldRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getBlocks = function (opts) { // getblocks
...
DeroGoldRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
DeroGoldRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
DeroGoldRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
DeroGoldRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
DeroGoldRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
DeroGoldRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
DeroGoldRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
DeroGoldRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
